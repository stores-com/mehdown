...
test('imgur', { concurrency: true }, async (t) => {
    await t.test('http://i.imgur.com/zvATqgs.gifv', async () => {
    ...
    await t.test('[text](http://i.imgur.com/zvATqgs.gifv)', async () => {
    ...
    await t.test('imgur.com/zvATqgs.gifv', async () => {
    ...
    await t.test('i.imgur.com/zvATqgs.gifv', async () => {
        const html = await render('i.imgur.com/zvATqgs.gifv');
        assert.strictEqual(html, '<p><div class="imgur-embed"><blockquote class="imgur-embed-pub" lang="en" data-id="zvATqgs"><a href="//imgur.com/zvATqgs">imgur.com/zvATqgs</a></blockquote><script async src="//s.imgur.com/min/embed.js" charset="utf-8"></script></div></p>');
    });

    await t.test('www.imgur.com/zvATqgs.gifv', async () => {
    ...
    await t.test('https://i.imgur.com/Al5Q80f.jpg', async () => {
    ...
    await t.test('https://i.imgur.com/PySOiro.gif', async () => {
    ...
    await t.test('https://i.imgur.com/XyXKUBp_d.jpg?maxwidth=640&shape=thumb&fidelity=medium', async () => {
    ...
    await t.test('[img]https://i.imgur.com/E5vZ9i1.jpg[/img]', async () => {
    ...
    await t.test('![](https://i.imgur.com/E5vZ9i1.jpg)', async () => {
