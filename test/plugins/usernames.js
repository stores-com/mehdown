...
test('usernames', { concurrency: true }, async (t) => {
    ...
    t.test('@username @othername', async () => {
    ...
    t.test('mediocre.com/@username', async () => {
    ...
    t.test('http://mediocre.com/@username', async () => {
    ...
    t.test('https://mediocre.com/@username', async () => {
    ...
    t.test('[@username](https://mediocre.com/@username)', async () => {
