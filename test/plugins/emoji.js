...
test('emoji', { concurrency: true }, async (t) => {
    ...
    t.test('mixed ascii, regular unicode and duplicate emoji', async () => {
    ...
    t.test('Unicode 9.0 and 10.0 emoji', async () => {
    ...
    t.test('jumbomoji (single emoji)', async () => {
    ...
    t.test('jumbomoji (multiple emoji)', async () => {
        const html = await render('😄 :smile:');
    ...
    t.test('jumbomoji (multiple line emoji)', async () => {
        const html = await render('😄\n:smile:');
