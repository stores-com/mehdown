...
test('images', { concurrency: true }, async (t) => {
    ...
    await t.test('.jpg with long url and query string', async () => {
    ...
    await t.test('.png with %20 (space) in url', async () => {
    ...
    await t.test('http://cl.ly/image/0w251W2U1f1Q/Screen%20Shot%202014-06-16%20at%201.26.25%20PM.png', async () => {
    ...
    await t.test('should not render image tags for image URLs in Markdown URL syntax', async () => {
