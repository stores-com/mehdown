...
test('mediocre.com', { concurrency: true }, async (t) => {
    ...
    t.test('https://mediocre.com/deals/a-slug', async () => {
    ...
    t.test('http://mediocre.com/deals/a-slug', async () => {
        const html = await render('http://mediocre.com/deals/a-slug');
        assert.strictEqual(html, '<p><iframe class="deals" frameborder="0" scrolling="no" src="https://mediocre.com/deals/a-slug/embed"></iframe></p>');
    });

    t.test('https://www.mediocre.com/deals/a-slug', async () => {
        const html = await render('https://www.mediocre.com/deals/a-slug');
        assert.strictEqual(html, '<p><iframe class="deals" frameborder="0" scrolling="no" src="https://mediocre.com/deals/a-slug/embed"></iframe></p>');
    });

    t.test('www.mediocre.com/deals/a-slug', async () => {
        const html = await render('www.mediocre.com/deals/a-slug');
        assert.strictEqual(html, '<p><iframe class="deals" frameborder="0" scrolling="no" src="https://mediocre.com/deals/a-slug/embed"></iframe></p>');
    });

    t.test('mediocre.com/deals/a-slug', async () => {
    ...
    t.test('https://mediocre.com/polls/a-slug', async () => {
    ...
    t.test('[text](https://mediocre.com/deals/a--slug)', async () => {
    ...
    t.test('[text](https://mediocre.com/polls/a--slug)', async () => {
    ...
    t.test('https://mediocritee.com/polls/a-slug', async () => {
    ...
    t.test('[text](https://mediocritee.com/polls/a--slug)', async () => {
    ...
    t.test('https://pastadrop.com/deals/a-slug', async () => {
    ...
    t.test('https://pastadrop.com/polls/a-slug', async () => {
