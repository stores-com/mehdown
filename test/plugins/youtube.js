...
test('youtube', { concurrency: true }, async (t) => {
    t.test('http://www.youtube.com/watch?v=kU9MuM4lP18', async () => {
    ...
    t.test('http://www.youtube.com/watch?v=kU9MuM4lP18 http://www.youtube.com/watch?v=eGDBR2L5kzI', async () => {
    ...
    t.test('http://www.youtube.com/watch?feature=player_embedded&v=zIEIvi2MuEk', async () => {
    ...
    t.test('`&amp;` instead of `&` in URL', async () => {
        const html = await render('http://www.youtube.com/watch?feature=player_embedded&amp;v=zIEIvi2MuEk');
        assert.strictEqual(html, '<p><iframe allowfullscreen class="youtube" frameborder="0" src="https://www.youtube.com/embed/zIEIvi2MuEk?autohide=1&color=white&showinfo=0&theme=light"></iframe></p>');
    });

    t.test('http://www.youtube.com/watch?v=kU9MuM4lP18&start=10', async () => {
    ...
    t.test('http://www.youtube.com/watch?v=kU9MuM4lP18&start=10&end=20', async () => {
    ...
    t.test('[text](http://www.youtube.com/watch?v=kU9MuM4lP18&start=10&end=20)', async () => {
    ...
    t.test('youtube.com/watch?v=kU9MuM4lP18', async () => {
        const html = await render('youtube.com/watch?v=kU9MuM4lP18');
        assert.strictEqual(html, '<p><iframe allowfullscreen class="youtube" frameborder="0" src="https://www.youtube.com/embed/kU9MuM4lP18?autohide=1&color=white&showinfo=0&theme=light"></iframe></p>');
    });

    t.test('www.youtube.com/watch?v=kU9MuM4lP18', async () => {
        const html = await render('www.youtube.com/watch?v=kU9MuM4lP18');
        assert.strictEqual(html, '<p><iframe allowfullscreen class="youtube" frameborder="0" src="https://www.youtube.com/embed/kU9MuM4lP18?autohide=1&color=white&showinfo=0&theme=light"></iframe></p>');
    });

    t.test('https://www.youtube.com/watch?v=ex--O-cJcZA', async () => {
